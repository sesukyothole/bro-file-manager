...
export function S3ConnectionModal({ isOpen, onClose, onConnected, userRole, onOpenS3Settings }: S3ConnectionModalProps) {
            ...
            <div className="space-y-6">
              <div className="p-5 bg-[rgba(61,143,140,0.12)] border border-[rgba(61,143,140,0.2)] rounded-xl relative overflow-hidden">
                ...
                <div className="relative z-10 flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-bold text-[var(--ink)] text-lg">Connected</h3>
                    <p className="text-[var(--muted)] text-sm mt-1">
                      Currently using <strong>{connection.config?.name || "S3 Storage"}</strong>
                    </p>
